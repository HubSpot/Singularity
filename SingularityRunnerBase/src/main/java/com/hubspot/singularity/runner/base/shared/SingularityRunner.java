...
public class SingularityRunner {
  ...
  public void run(Iterable<? extends Module> modules) {
    ...
    final SingularityRunnerExceptionNotifier exceptionNotifier = injector.getInstance(
      SingularityRunnerExceptionNotifier.class
    );
    ...
    try {
      ...
      exceptionNotifier.notify(
        String.format("Unexpected exception in runner (%s)", t.getMessage()),
        t,
