        ...
        <div className="row new-form">
          <form className="col-md-8">
            ...
            <div className="well">
              ...
              { this.getExecutorType() === DEFAULT_EXECUTOR_TYPE ? this.renderDefaultExecutorFields() : null }
              { this.getExecutorType() === CUSTOM_EXECUTOR_TYPE ? this.renderCustomExecutorFields() : null }
            </div>
          </form>
