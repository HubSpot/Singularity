    ...
    renderTableRow={(data, index) => {
      return (
        <tr key={index}>
          ...
          <td className="actions-column"><Link to={`request/${data.taskId.requestId}/tail/${config.runningTaskLogPath}?taskIds=${data.taskId.id}`} title="Log">&middot;&middot;&middot;</Link></td>
