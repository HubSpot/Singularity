...
const DISABLED_ACTION_TYPES = [
  'BOUNCE_REQUEST', 'SCALE_REQUEST', 'PRIORITY_REQUEST', 'REMOVE_REQUEST', 'CREATE_REQUEST', 'UPDATE_REQUEST','KILL_TASK', 
  'BOUNCE_TASK', 'RUN_HEALTH_CHECKS', 'RUN_SHELL_COMMAND', 'ADD_METADATA', 'DEPLOY', 'CANCEL_DEPLOY', 'ADD_WEBHOOK', 'REMOVE_WEBHOOK',
  'TASK_RECONCILIATION', 'FREEZE_AGENT', 'ACTIVATE_AGENT', 'DECOMMISSION_AGENT', 'VIEW_AGENTS','FREEZE_RACK',
  'ACTIVATE_RACK', 'DECOMMISSION_RACK', 'VIEW_RACKS', 'PROCESS_OFFERS', 'CACHE_OFFERS', 'SEND_EMAIL', 'STARTUP_TASK_RECONCILIATION',
  'RUN_CLEANUP_POLLER', 'RUN_DEPLOY_POLLER', 'RUN_SCHEDULER_POLLER', 'RUN_EXPIRING_ACTION_POLLER', 'TASK_SHUFFLE'
];
