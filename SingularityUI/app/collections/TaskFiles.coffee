...
class TaskFiles extends Collection
    ...
    url: ->
        ...
        "#{ window.singularity.config.apiBase }/sandbox/#{ @taskId }/browse?#{ $.param params }"
    ...
    parse: (taskFiles) ->
        _.map taskFiles, (taskLogFile) =>
            ...
            taskLogFile.downloadLink = "#{ window.singularity.config.apiBase }/sandbox/#{ @taskId }/download?#{ downloadParams }"
