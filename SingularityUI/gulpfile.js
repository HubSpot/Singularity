...
var templateData = {
  ...
  slaveCpusWarningThreshold: process.env.SINGULARITY_SLAVE_CPUS_WARNING_THRESHOLD || 0.80,
  slaveCpusCriticalThreshold: process.env.SINGULARITY_SLAVE_CPUS_CRITICAL_THRESHOLD || 0.90,
  slaveMemoryWarningThreshold: process.env.SINGULARITY_SLAVE_MEMORY_WARNING_THRESHOLD || 0.80,
  slaveMemoryCriticalThreshold: process.env.SINGULARITY_SLAVE_MEMORY_CRITICAL_THRESHOLD || 0.90,
