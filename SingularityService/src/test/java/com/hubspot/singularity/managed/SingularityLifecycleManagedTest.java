...
public class SingularityLifecycleManagedTest extends SingularityLifecycleManaged {
  ...
  public SingularityLifecycleManagedTest(SingularityManagedCachedThreadPoolFactory cachedThreadPoolFactory,
    ...
    super(cachedThreadPoolFactory, scheduledExecutorServiceFactory, asyncHttpClient, curatorFramework, leaderController, leaderLatch, executorInfoSupport, graphiteReporter, executorIdGenerator, cache, listeners, leaderOnlyPollers);
  }
