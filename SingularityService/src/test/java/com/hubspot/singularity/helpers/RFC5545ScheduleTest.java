...
public class RFC5545ScheduleTest {
  ...
  public void testEveryWeekdayRFC5545Schdule() throws Exception {
    ...
    Assertions.assertTrue(nextValidTime.before(new Date(System.currentTimeMillis() + TimeUnit.DAYS.toMillis(3))));
  }

  @Test
  public void testMaxIterations() throws Exception {
    String schedule = "DTSTART=19970902T090000\nRRULE:FREQ=HOURLY;COUNT=10001";
    Assertions.assertEquals(new RFC5545Schedule(schedule).getStartDateTime(), new org.joda.time.DateTime(1997, 9, 2, 9, 0, 0));
