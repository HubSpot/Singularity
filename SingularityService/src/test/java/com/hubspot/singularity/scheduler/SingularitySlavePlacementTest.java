...
public class SingularitySlavePlacementTest extends SingularitySchedulerTestBase {
  ...
  public void testSlavePlacementSpread() {
    ...
    sms.resourceOffers(driver, Arrays.asList(createOffer(20, 0, 20000, "slave1", "host1", Optional.of("rack1"))));
  ...
  public void testEvenRackPlacement() {
    ...
    sms.resourceOffers(driver, Arrays.asList(createOffer(1, 0, 128, "slave1", "host1", Optional.of("rack1"))));
    sms.resourceOffers(driver, Arrays.asList(createOffer(1, 0, 128, "slave2", "host2", Optional.of("rack2"))));
    sms.resourceOffers(driver, Arrays.asList(createOffer(1, 0, 128, "slave3", "host3", Optional.of("rack3"))));
  ...
  public void testRackPlacementOnScaleDown() {
    try {
      ...
      sms.resourceOffers(driver, Arrays.asList(createOffer(2, 0, 256, "slave1", "host1", Optional.of("rack1"))));
      sms.resourceOffers(driver, Arrays.asList(createOffer(2, 0, 256, "slave2", "host2", Optional.of("rack2"))));
      sms.resourceOffers(driver, Arrays.asList(createOffer(3, 0, 384, "slave3", "host3", Optional.of("rack3"))));
  ...
  public void testPlacementOfBounceTasks() {
    ...
    sms.resourceOffers(driver, Arrays.asList(createOffer(1, 0, 128, "slave1", "host1", Optional.of("rack1"))));
    sms.resourceOffers(driver, Arrays.asList(createOffer(1, 0, 128, "slave2", "host2", Optional.of("rack1"))));
