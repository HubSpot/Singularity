...
public class TaskResource extends AbstractLeaderAwareResource {
  ...
  public List<SingularityTaskId> getTaskIdsForSlave(
    ...
    return authorizationHelper.filterByAuthorizedRequests(user, taskManager.getTaskIdsOnSlave(taskManager.getActiveTaskIds(skipCache), maybeSlave.get()), SingularityTransformHelpers.TASK_ID_TO_REQUEST_ID, SingularityAuthorizationScope.READ);
  }
