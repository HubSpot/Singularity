...
public class IndexView extends View {
  ...
  private final String customQuickLinks;
  ...
  public IndexView(SingularityConfiguration configuration, ObjectMapper objectMapper) {
    ...
    try {
      customQuickLinks = objectMapper.writeValueAsString(configuration.getUiConfiguration().getCustomQuickLinks());
    }
  ...
  public String getCustomQuickLinks() {
  ...
  public String toString() {
    return "IndexView [appRoot=" + appRoot + ", staticRoot=" + staticRoot + ", apiRoot=" + apiRoot + ", navColor=" + navColor + ", defaultMemory=" + defaultMemory + ", defaultCpus=" + defaultCpus
        ...
        + slaveHttpsPort + ", customQuickLinks=" + customQuickLinks + "]";
  }
