...
public class SingularityTaskIdHistoryMapper implements ResultSetMapper<SingularityTaskIdHistory> {
  ...
  public SingularityTaskIdHistory map(int index, ResultSet r, StatementContext ctx) throws SQLException {
    ...
    return new SingularityTaskIdHistory(SingularityTaskId.fromString(r.getString("taskId")), r.getString("requestId"), Optional.fromNullable(r.getString("lastTaskStatus")), r.getTimestamp("createdAt").getTime(), 
        maybeUpdatedAt, Optional.fromNullable(r.getString("directory")), r.getString("pendingType"));
  }
