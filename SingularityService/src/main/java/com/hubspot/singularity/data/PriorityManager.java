...
public class PriorityManager extends CuratorAsyncManager {
  ...
  public PriorityManager(
    ...
    Transcoder<SingularityPriorityFreezeParent> priorityFreezeParentTranscoder
  ) {
    super(curator, configuration, metricRegistry);
    this.priorityFreezeParentTranscoder = priorityFreezeParentTranscoder;
    this.defaultTaskPriorityLevelForRequestType =
      configuration.getDefaultTaskPriorityLevelForRequestType();
  ...
  public SingularityCreateResult createPriorityFreeze(
    SingularityPriorityFreezeParent priorityFreeze
  ) {
  ...
  public double getTaskPriorityLevelForRequest(SingularityRequest request) {
    return request
      ...
      .orElse(
        Optional
          .ofNullable(
            defaultTaskPriorityLevelForRequestType.get(request.getRequestType())
          )
          .orElse(defaultTaskPriorityLevel)
      );
  }
}
