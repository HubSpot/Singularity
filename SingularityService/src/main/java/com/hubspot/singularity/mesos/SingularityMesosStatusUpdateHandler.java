...
public class SingularityMesosStatusUpdateHandler {
  ...
  private void unsafeProcessStatusUpdate(Protos.TaskStatus status) {
    ...
    final SingularityTaskStatusHolder newTaskStatusHolder = new SingularityTaskStatusHolder(taskIdObj, Optional.of(MesosTaskStatusObject.fromProtos(status)), System.currentTimeMillis(), serverId, Optional.<String>absent());
