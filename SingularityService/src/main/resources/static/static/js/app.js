...
Requests = (function(_super) {
  ...
  Requests.prototype.parseDeployUser = function(request) {
    ...
    return ((_ref = (_ref1 = request.executorData) != null ? (_ref2 = _ref1.env) != null ? _ref2.DEPLOY_USER : void 0 : void 0) != null ? _ref : '').split('@')[0];
  };
...
TasksActive = (function(_super) {
  ...
  function TasksActive() {
    return TasksActive.__super__.constructor.apply(this, arguments);
  }
...
TasksScheduled = (function(_super) {
  ...
  function TasksScheduled() {
    return TasksScheduled.__super__.constructor.apply(this, arguments);
  }
