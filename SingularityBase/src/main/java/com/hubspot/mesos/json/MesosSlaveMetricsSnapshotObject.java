...
public class MesosSlaveMetricsSnapshotObject {
  ...
  @JsonCreator
  public MesosSlaveMetricsSnapshotObject(
    @JsonProperty("slave/disk_used") double slaveDiskUsed,
    ...
    ) double slaveExecutorDirectoryMaxAllowedAgeSecs,
    ...
    ) double slaveInvalidFrameworkMessages,
    ...
    this.slaveExecutorDirectoryMaxAllowedAgeSecs =
      slaveExecutorDirectoryMaxAllowedAgeSecs;
  ...
  public String toString() {
    return (
      "MesosSlaveMetricsSnapshotObject{" +
      "slaveDiskUsed=" +
      slaveDiskUsed +
      ...
      ", slaveRegistered=" +
      slaveRegistered +
      ", slaveGpusRevocableTotal=" +
      slaveGpusRevocableTotal +
      ", containerizerMesosProvisionerRemoveContainerErrors=" +
      containerizerMesosProvisionerRemoveContainerErrors +
      ", slaveCpusRevocableUsed=" +
      slaveCpusRevocableUsed +
      ", slaveDiskTotal=" +
      slaveDiskTotal +
      ", slaveTasksStaging=" +
      ...
      ", slaveExecutorDirectoryMaxAllowedAgeSecs=" +
      slaveExecutorDirectoryMaxAllowedAgeSecs +
      ", slaveDiskRevocablePercent=" +
      slaveDiskRevocablePercent +
      ", systemLoad1Min=" +
      systemLoad1Min +
      ", slaveMemPercent=" +
      slaveMemPercent +
      ", slaveContainerLaunchErrors=" +
      slaveContainerLaunchErrors +
      ", slaveMemRevocableUsed=" +
      slaveMemRevocableUsed +
      ", slaveTasksRunning=" +
      slaveTasksRunning +
      ...
      ", slaveTasksKilling=" +
      slaveTasksKilling +
      ", slaveDiskRevocableTotal=" +
      slaveDiskRevocableTotal +
      ", slaveGpusRevocablePercent=" +
      slaveGpusRevocablePercent +
      ", slaveDiskRevocableUsed=" +
      slaveDiskRevocableUsed +
      ", slaveUptimeSecs=" +
      slaveUptimeSecs +
      ", slaveDiskPercent=" +
