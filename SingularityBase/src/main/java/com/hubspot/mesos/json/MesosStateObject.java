...
public class MesosStateObject {
  ...
  private final List<MesosSlaveObject> slaves;
  private final List<MesosFrameworkObject> frameworks;
  
  @JsonCreator
  public MesosStateObject(@JsonProperty("activated_slaves") int activatedSlaves, @JsonProperty("deactivated_slaves") int deactivatedSlaves, @JsonProperty("failed_tasks") int failedTasks, 
      ...
      @JsonProperty("slaves") List<MesosSlaveObject> slaves, @JsonProperty("frameworks") List<MesosFrameworkObject> frameworks) {
  ...
  public List<MesosSlaveObject> getSlaves() {
    return slaves;
  }
