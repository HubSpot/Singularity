...
public class SingularityTaskReconciliationStatistics {
  ...
  public SingularityTaskReconciliationStatistics(
    @JsonProperty("taskReconciliationStartedAt") long taskReconciliationStartedAt,
    @JsonProperty(
      "taskReconciliationDurationMillis"
    ) long taskReconciliationDurationMillis,
    ...
    ) double taskReconciliationResponseStddev
  ) {
  ...
  @Schema(
    description = "Average time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "Minimum time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "50th percentile time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "75th percentile time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "95th percentile time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "98th percentile time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "99th percentile time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "99.9th percentile time taken for a response during the last reconciliation"
  )
  ...
  @Schema(
    description = "Standard deviation in response time during the last reconciliation"
  )
