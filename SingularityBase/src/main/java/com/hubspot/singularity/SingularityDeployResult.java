...
public class SingularityDeployResult {
  ...
  public SingularityDeployResult(DeployState deployState) {
    this(deployState, Optional.<String>empty(), Optional.<SingularityLoadBalancerUpdate>empty(), Collections.<SingularityDeployFailure> emptyList(), System.currentTimeMillis());
  }

  public SingularityDeployResult(DeployState deployState, String message) {
    this(deployState, Optional.of(message), Optional.<SingularityLoadBalancerUpdate>empty(), Collections.<SingularityDeployFailure> emptyList(), System.currentTimeMillis());
  }
