...
public class SingularityRequestParent {
  ...
  public SingularityRequestParent(SingularityRequest request, RequestState state) {
    this(request, state, Optional.empty());
  }
  ...
  @Schema(
    description = "Full data for the request, a parent object for any deployed task"
  )
  ...
  @Schema(
    description = "Data about any active and/or pending deploys for this request",
    nullable = true
  )
  ...
  @Schema(
    description = "Settings for a pending/in-progress deploy, may not contain the full deploy json",
    nullable = true
  )
  ...
  @Schema(
    description = "Expiring bounce action details if one is active",
    nullable = true
  )
  ...
  @Schema(
    description = "Details about an expiring pause if one is present",
    nullable = true
  )
  ...
  @Schema(
    description = "Details about a scale action that will eventually revert, if one is present",
    nullable = true
  )
  ...
  @Schema(
    description = "Details about a skip healthchecks action that will eventually revert",
    nullable = true
  )
