...
public class SingularityTaskCurrentUsageWithId extends SingularityTaskCurrentUsage {
  ...
  public SingularityTaskCurrentUsageWithId(
    ...
    SingularityTaskCurrentUsage taskCurrentUsage
  ) {
    super(
      taskCurrentUsage.getMemoryTotalBytes(),
      taskCurrentUsage.getTimestamp(),
      taskCurrentUsage.getCpusUsed(),
      taskCurrentUsage.getDiskTotalBytes()
    );
    this.taskId = taskId;
  }
  ...
  public String toString() {
    return (
      "SingularityTaskCurrentUsageWithId [taskId=" +
      taskId +
      ", super=" +
      super.toString() +
      "]"
