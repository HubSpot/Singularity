...
public class SingularityState {
  ...
  private final boolean schedulerClientRunning;
  ...
  public SingularityState(
    ...
    boolean schedulerClientRunning
  ) {
    this(
      activeTasks,
      launchingTasks,
  ...
  public SingularityState(
    ...
    @JsonProperty("schedulerClientRunning") boolean schedulerClientRunning
  ) {
    ...
    this.schedulerClientRunning = schedulerClientRunning;
  }
  ...
  @Schema(description = "Indicator to see if the scheduler client is running")
  public boolean isSchedulerClientRunning() {
    return schedulerClientRunning;
  }
