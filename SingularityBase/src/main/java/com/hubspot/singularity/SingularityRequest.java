...
public class SingularityRequest {
  ...
  public SingularityRequest(@JsonProperty("id") String id, @JsonProperty("requestType") RequestType requestType, @JsonProperty("owners") Optional<List<String>> owners,
      ...
      @JsonProperty("quartzSchedule") Optional<String> quartzSchedule, @JsonProperty("scheduledTimeZone") Optional<TimeZone> scheduledTimeZone, @JsonProperty("rackAffinity") Optional<List<String>> rackAffinity,
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, request.id) &&
            ...
            Objects.equals(scheduledTimeZone, request.scheduledTimeZone) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, requestType, owners, numRetriesOnFailure, schedule, quartzSchedule, scheduledTimeZone, scheduleType, killOldNonLongRunningTasksAfterMillis, scheduledExpectedRuntimeMillis, waitAtLeastMillisAfterTaskFinishesForReschedule, instances, rackSensitive, rackAffinity, slavePlacement, requiredSlaveAttributes, allowedSlaveAttributes, loadBalanced, group, readOnlyGroups, bounceAfterScale, emailConfigurationOverrides, hideEvenNumberAcrossRacksHint, taskLogErrorRegex, taskLogErrorRegexCaseSensitive, taskPriorityLevel);
  }
}
