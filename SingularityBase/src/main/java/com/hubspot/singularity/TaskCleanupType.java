...
public enum TaskCleanupType {
  ...
  OVERDUE_NEW_TASK(true, true), USER_REQUESTED_DESTROY(true, true), PRIORITY_KILL(true, true), INCREMENTAL_DEPLOY_FAILED(false, true), INCREMENTAL_DEPLOY_CANCELLED(false, true);
