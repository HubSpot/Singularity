...
public enum TaskCleanupType {
  ...
  DEPLOY_FAILED(false, true), NEW_DEPLOY_SUCCEEDED(true, false), DEPLOY_STEP_FINISHED(true, false), DEPLOY_CANCELED(false, true), UNHEALTHY_NEW_TASK(true, true), OVERDUE_NEW_TASK(true, true), PRIORITY_KILL(true, true);
