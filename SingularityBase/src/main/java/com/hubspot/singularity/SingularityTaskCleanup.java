...
public class SingularityTaskCleanup {
  ...
  @JsonCreator
  public SingularityTaskCleanup(
    @JsonProperty("user") Optional<String> user,
    @JsonProperty("cleanupType") TaskCleanupType cleanupType,
  ...
  @Schema(
    description = "An optional unique id associted with the cleanup of this task",
    nullable = true
  )
  ...
  @Schema(
    description = "An optional message describing the reason this task was cleaned",
    nullable = true
  )
