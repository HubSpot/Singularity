...
public class SingularityExpiringScale
  ...
  public SingularityExpiringScale(
    @JsonProperty("requestId") String requestId,
    @JsonProperty("user") Optional<String> user,
    @JsonProperty("startMillis") long startMillis,
    @JsonProperty("expiringAPIRequestObject") SingularityScaleRequest scaleRequest,
    @JsonProperty("revertToInstances") Optional<Integer> revertToInstances,
  ...
  @Schema(
    description = "The instance count to update to when time has elapsed",
    nullable = true
  )
  ...
  @Schema(
    description = "If the scale action when updating instance count should also trigger a bounce",
    nullable = true,
    defaultValue = "false"
  )
