...
public class SingularityTaskRequest implements Comparable<SingularityTaskRequest> {
  ...
  @Schema(title = "The SingularityRequest data used at the time this task was launched")
  public SingularityRequest getRequest() {
    return request;
  }

  @Schema(title = "The full SingularityDeploy data associated with this task")
  public SingularityDeploy getDeploy() {
    return deploy;
  }

  @Schema(title = "Overrides and settings associated with this particular task")
