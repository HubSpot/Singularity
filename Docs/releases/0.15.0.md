...
### New Features
- [1519](https://github.com/HubSpot/Singularity/pull/1519) - Spread to all agents
...
- [1405](https://github.com/HubSpot/Singularity/pull/1405) - Agent Usage Monitoring UI
...
- [1480](https://github.com/HubSpot/Singularity/pull/1480) - Put a limit on number of agents to decommission at once
...
- [1400](https://github.com/HubSpot/Singularity/pull/1400) - Add agent and task usage tracking inside singularity ZK
...
- [1428](https://github.com/HubSpot/Singularity/pull/1428) - Prevent flapping agent from rejoining cluster
